...
UBOOT_TOOLS_SITE = ssh://gerrit.elvees.com:29418/mcom02/u-boot
...
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_MCOM02_FW_UPDATE),y)
define UBOOT_TOOLS_INSTALL_MCOM02_FW_UPDATE
	$(INSTALL) -m 0755 -D $(@D)/tools/mcom02-fw-update $(TARGET_DIR)/usr/sbin/mcom02-fw-update
endef
endif

ifneq ($(BR2_PACKAGE_UBOOT_TOOLS_FWPRINTENV)$(BR2_PACKAGE_UBOOT_TOOLS_MCOM02_FW_UPDATE),)
define UBOOT_TOOLS_INSTALL_ENVIRONMENT_CONFIG
	$(INSTALL) -m 0644 -D $(@D)/tools/env/fw_env.config $(TARGET_DIR)/etc/fw_env.config
endef
endif
...
define UBOOT_TOOLS_INSTALL_TARGET_CMDS
	...
	$(UBOOT_TOOLS_INSTALL_MCOM02_FW_UPDATE)
