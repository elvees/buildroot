...
ifeq ($(BR2_PACKAGE_LINUX_FIRMWARE_INSTALL_IMAGES),y)
...
ifeq ($(BR2_PACKAGE_LINUX_FIRMWARE_LONTIUM),y)
LINUX_FIRMWARE_FILES += lt9611uxc_fw.bin
LINUX_FIRMWARE_ALL_LICENSE_FILES += LICENSE.Lontium
endif
