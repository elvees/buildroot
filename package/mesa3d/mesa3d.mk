...
MESA3D_VERSION = powervr-17.0.y
MESA3D_SITE = ssh://gerrit.elvees.com:29418/tools/mesa
MESA3D_SITE_METHOD = git
MESA3D_LICENSE = Proprietary
...
ifeq ($(BR2_PACKAGE_MESA3D_DRI_DRIVER_PVR),y)
MESA3D_DEPENDENCIES += mcom03-rogue-libs
endif
endif
