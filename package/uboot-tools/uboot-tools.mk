...
UBOOT_TOOLS_SITE = ssh://gerrit.elvees.com:29418/mcom03/u-boot
...
ifneq ($(BR2_PACKAGE_UBOOT_TOOLS_FWPRINTENV)$(BR2_PACKAGE_UBOOT_TOOLS_MCOM03_UTILS),)
...
define UBOOT_TOOLS_INSTALL_TARGET_CMDS
	...
	$(UBOOT_TOOLS_INSTALL_MCOM03_UTILS)
